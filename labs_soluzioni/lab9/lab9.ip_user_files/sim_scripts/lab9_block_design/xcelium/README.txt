...
#
# Generated by export_simulation on Wed Feb 11 10:18:38 CET 2026
#
################################################################################
...
'-reset_run' switch to the './lab9_block_design.sh' script.

./lab9_block_design.sh -reset_run
...
./lab9_block_design.sh -noclean_files

For more information on the script, please type './lab9_block_design.sh -help'.
